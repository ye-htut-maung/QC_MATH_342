...
=
\begin{bmatrix}
(a_{11}c_1 + \cdots + a_{n1}c_n) & \cdots & (a_{1n}c_1 + \cdots + a_{nn}c_n)
\end{bmatrix}
\begin{bmatrix}
c_1 \\
\vdots \\
...
=
\begin{bmatrix}
\sum\limits_{i=1}^{n} a_{i1} c_i & \cdots & \sum\limits_{i=1}^{n} a_{in} c_i
\end{bmatrix}
\begin{bmatrix}
c_1 \\
\vdots \\
...
\[
=
c_1 \sum\limits_{i=1}^{n} a_{i1} c_i + \cdots + c_n \sum\limits_{i=1}^{n} a_{in} c_i
\]

\[
=
\sum\limits_{j=1}^{n} c_j \sum\limits_{i=1}^{n} a_{ij} c_i
\]

\[
=
\sum\limits_{j=1}^{n} \sum\limits_{i=1}^{n} a_{ij} c_i c_j
\]

\[
\frac{\partial \mathbf{c}^\top A \mathbf{c}}{\partial \mathbf{c}} =
\begin{bmatrix}
\frac{\partial \mathbf{c}^\top A \mathbf{c}}{\partial c_1} \\
\vdots \\
\frac{\partial \mathbf{c}^\top A \mathbf{c}}{\partial c_n}
\end{bmatrix}
\]
...
\[
\frac{\partial \mathbf{c}^\top A \mathbf{c}}{\partial c_k}
= \frac{\partial}{\partial c_k} \left( \sum\limits_{j=1}^{n} \sum\limits_{i=1}^{n} a_{ij} c_i c_j \right)
\]

\[
= \frac{\partial}{\partial c_k} \left( c_1 \sum\limits_{i=1}^{n} a_{i1} c_i + \cdots + c_k \sum\limits_{i=1}^{n} a_{ik} c_i + c_k a_{kk} + \cdots + c_n \sum\limits_{i=1}^{n} a_{in} c_i \right)
\]

\[
= c_1 a_{k1} + \cdots + \left( \sum\limits_{i=1}^{n} a_{ik} c_i + c_k a_{kk} \right) + \cdots + c_n a_{kn}
\]

\[
= \sum\limits_{j=1}^{n} a_{kj} c_j + \sum\limits_{i=1}^{n} a_{ik} c_i
\]

\[
= (\text{k}^{th} \text{ row of } A) \mathbf{c} + (\text{transpose of } \text{k}^{th} \text{ column of } A) \mathbf{c}
\]

\[
= \left[ (\text{k}^{th} \text{ row of } A) + (\text{transpose of } \text{k}^{th} \text{ column of } A) \right] \mathbf{c}
\]
...
\frac{\partial \mathbf{c}^\top A \mathbf{c}}{\partial \mathbf{c}} =
\begin{bmatrix}
(\text{1st row of } A) + (\text{transpose of 1st column of } A) \mathbf{c} \\
\vdots \\
(\text{n}^{th} \text{ row of } A) + (\text{transpose of } n^{th} \text{ column of } A) \mathbf{c}
\end{bmatrix}
\]
...
=
\begin{bmatrix}
(\text{1st row of } A) + (\text{transpose of 1st column of } A) \\
\vdots \\
(\text{n}^{th} \text{ row of } A) + (\text{transpose of } n^{th} \text{ column of } A)
...
\text{1st row of } A \\
\vdots \\
\text{n}^{th} \text{ row of } A
\end{bmatrix} 
+ 
\begin{bmatrix}
\text{transpose of 1st column of } A \\
\vdots \\
\text{transpose of } n^{th} \text{ column of } A
\end{bmatrix} 
\right) \mathbf{c}
\]
...
Let \( \vec{v} \in \text{Nullsp}(X^T X) \Rightarrow X^T X \vec{v} = \vec{0}_{p+1} \)

\[
\Rightarrow \vec{v}^T X^T X \vec{v} = \vec{v}^T \vec{0}_{p+1} = 0
\]

\[
\Rightarrow (X \vec{v})^T (X \vec{v}) = 0 \Rightarrow X \vec{v} = \vec{0}_n \Rightarrow \vec{v} \in \text{Nullsp}(X)
\]

Let \( \vec{v} \in \text{Nullsp}(X) \Rightarrow X \vec{v} = \vec{0}_n \Rightarrow X^T X \vec{v} = X^T \vec{0}_n = \vec{0}_{p+1} \)

\[
\Rightarrow \vec{v} \in \text{Nullsp}(X^T X)
\]

\[
\text{Nullsp}(X^T X) = \text{Nullsp}(X) \Rightarrow \text{Nullity} (X^T X) = \text{Nullity} (X)
\]

By the rank-nullity theorem:

\begin{equation}
\text{Nullity} (X^T X) + \text{rank} (X^T X) = p+1
\end{equation}

\begin{equation}
\text{Nullity} (X) + \text{rank} (X) = p+1
\end{equation}

Subtracting equation (2) from equation (1):

\[
[\text{Nullity} (X^T X) + \text{rank} (X^T X)] - [\text{Nullity} (X) + \text{rank} (X)] = 0
\]

Since \(\text{Nullity} (X^T X) = \text{Nullity} (X)\), this simplifies to:

\[
\text{rank} (X^T X) - \text{rank} (X) = 0
\]
...
The predicted values from the regression model are given by:
...
\[
= n \bar{y} - n \bar{y} + n b_1 \bar{x} - n b_1 \bar{x}
\]
...
\[
\bar{e} = \frac{1}{n} \sum_{i=1}^{n} e_i = \frac{1}{n} \times 0 = 0
\]
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{IMG_78133816E0B7-1.jpeg}
    \caption{Problem 6(i)}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{IMG_33A54ECB3C60-1.jpeg}
    \caption{Problem 6(i)}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{IMG_4ACE2B450072-1.jpeg}
    \caption{Problem 6(i)}
    \label{fig:enter-label}
\end{figure}
...
\[
(\cos\theta)^2 = \frac{\left\| \hat{y} - \bar{y} \cdot \hat{1}_n \right\|^2}{\left\| y - \bar{y} \cdot \hat{1}_n \right\|^2}
\]
...
Since \( (\cos\theta)^2 \in [0,1] \), we see that \( R^2 \in [0,1] \).
