...
table(diamonds$color_as_nomial)
table(diamonds$color)
```
...
# It doesn't do well and similar error as before.
...
#TO-DO
I think they are both bad as the errors are high. However, I think color_as_nominal is a bit better as the error is a little bit low. 
...
- It doesn't do better than either color_as_numeric or color_as_nominal alone because it has redundent as both values are the same with different type of normalize value or unit.
